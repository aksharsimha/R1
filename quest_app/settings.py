...
def _render_signout_section() -> None:
    _card_start("Sign out", "End this QUEST session on this device.")
    st.markdown(
        "<p style='color: var(--q-text-2); font-size: 0.88rem; margin-bottom: 20px;'>"
        "Signing out will disconnect your active session. Your saved portfolio data and profile settings remain securely stored in the cloud."
        "</p>",
        unsafe_allow_html=True,
    )
