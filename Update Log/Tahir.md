...
## 2026-08-27
- Fixed login and logout URL query parameter handling by removing stale `logged_out` parameter writes and cleanup.
...
- Consolidated recent planner, chat, and team update-log documentation.